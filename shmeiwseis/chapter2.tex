...
\item {}
  \begin{enumerate}[i)] \label{rem:nonfragm}
    ...
    \item \label{rem:nonfragm2}
      Ενδιαφέρον έχει το αντιθετοαντίστροφο της παραπάνω πρότασης, που 
...
\item {}
  \begin{enumerate}[i)]
    ...
    \item $ \displaystyle
      ...
      (+\infty)\cdot \frac{5+0+0}{2+0+0} = +\infty \cdot \frac{5}{2} = + \infty $
...
\begin{example}
  ...
  \begin{proof}
    Έχουμε ότι 
    \flushleft\parbox[b]{9cm}{\begin{myitemize}
...
\begin{proof}
  \item {}
    ...
    (Αρχ. Ιδιοτ.) ώστε $ \forall n \geq n_{0} $ να ισχύει $ n \geq n_{0} > 
    \frac{M+2}{3} $, άρα και $ 3n-2>M $.
\end{proof}
...
\begin{proof}
  ...
  ώστε $ \forall n \geq n_{0} $ να ισχύει $ n > 4M+1 $, άρα και $ \frac{1-n}{4}
 < -M $.
\end{proof}
